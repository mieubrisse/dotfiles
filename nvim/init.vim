...
" ---------------------- nvim-cmp ----------------------
"  TODO Figure out a way to extract this into a better directory format
"  Some clues here: https://threkk.medium.com/how-to-have-a-neovim-configuration-compatible-with-vim-b5a46723145e
if has('nvim')
    source ~/.config/nvim/configure-cmp.lua
endif
