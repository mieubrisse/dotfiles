...
description: Transform, upgrade, and optimize AI system prompts. Use when asked to improve a prompt, create a system prompt, write instructions for an AI agent, or optimize prompt effectiveness. Especially, CLAUDE.md, AGENTS.md, or SKILL.md.
argument-hint: "[agent-name or prompt text]"
---
